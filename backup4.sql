...
prompt Created by gilad on יום ראשון 14 יולי 2024
set feedback off
set define off
...
prompt Creating COMMANDERE...
create table COMMANDERE
(
  numberofsoldiers INTEGER not null,
  soldierid        INTEGER not null
)
;
alter table COMMANDERE
  add primary key (SOLDIERID);
alter table COMMANDERE
...
(
  ...
  comid        NUMBER not null,
  departmentid NUMBER not null
)
;
alter table TRAINING
  add primary key (TDATE, TYPE, COMID, DEPARTMENTID);
...
prompt Truncating COMMANDERE...
truncate table COMMANDERE;
...
insert into COMMANDER (comid, rank, numofunitcom)
...
prompt Loading COMMANDERE...
insert into COMMANDERE (numberofsoldiers, soldierid)
values (9, 451);
insert into COMMANDERE (numberofsoldiers, soldierid)
values (9, 452);
insert into COMMANDERE (numberofsoldiers, soldierid)
...
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('01-08-2024', 'dd-mm-yyyy'), 'dressings', 854567801, 1);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('03-08-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 597170275, 10);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('05-08-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 284456997, 15);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('07-08-2024', 'dd-mm-yyyy'), 'dressings', 382340873, 20);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('09-08-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 456542193, 25);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('11-08-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 239021751, 30);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('13-08-2024', 'dd-mm-yyyy'), 'dressings', 784035019, 35);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('15-08-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 458692899, 40);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('17-08-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 513254138, 45);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('19-08-2024', 'dd-mm-yyyy'), 'dressings', 733741583, 50);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('21-08-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 676175225, 5);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('23-08-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 292483544, 6);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('25-08-2024', 'dd-mm-yyyy'), 'dressings', 376752575, 7);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('27-08-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 383487578, 8);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('29-08-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 661373728, 9);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('31-08-2024', 'dd-mm-yyyy'), 'dressings', 611570580, 10);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('02-09-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 646340985, 11);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('04-09-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 477760344, 12);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('06-09-2024', 'dd-mm-yyyy'), 'dressings', 933504468, 13);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('08-09-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 262033320, 14);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('10-09-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 841282743, 15);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('12-09-2024', 'dd-mm-yyyy'), 'dressings', 428132844, 16);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('14-09-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 341861776, 17);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('16-09-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 910219884, 18);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('18-09-2024', 'dd-mm-yyyy'), 'dressings', 960434058, 19);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('20-09-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 253790977, 20);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('22-09-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 470519370, 21);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('24-09-2024', 'dd-mm-yyyy'), 'dressings', 303704035, 22);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('26-09-2024', 'dd-mm-yyyy'), 'multiple_casualty_incident', 246498308, 23);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('28-09-2024', 'dd-mm-yyyy'), 'casualty_evacuation', 905791950, 24);
insert into TRAINING (tdate, type, comid, departmentid)
values (to_date('30-09-2024', 'dd-mm-yyyy'), 'dressings', 539094185, 25);
commit;
